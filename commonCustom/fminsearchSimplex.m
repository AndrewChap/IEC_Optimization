function [x,fval,exitflag,output] = fminsearchSimplex(funfcn,x,initialSimplex,options,varargin)
% Drew's modification of fminsearch to specify the initial simplex relative
...
% includes Drew's initial simplex modification
for j = 1:n
    y = xin;
%     if y(j) ~= 0
